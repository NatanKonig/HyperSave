...
from hypersave.plugins.download_handler import download_manager
from hypersave.plugins.download_handler import upload_manager
from hypersave.plugins.download_handler import user_manager
...
@ClientBot.on_message(filters.command("users") & filters.private & custom_filters.is_admin)
