...
class UserSessionManager:
    ...
    async def get_or_create_user_client(
    ...
    async def enqueue_download(
        self, user_id: str, download_task: callable, priority: int = 0
    ) -> asyncio.Future:
        """
    ...
    async def download_media(
        self, user_id: str, session_string: str, chat_id: int, message_id: int
    ) -> str:
        """
...
class DownloadManager:
    ...
    async def download_from_url(
        self, user_id: str, session_string: str, url: str
    ) -> str:
        """
        ...
        try:
            ...
            media_path = await self.user_session_manager.download_media(
                user_id, session_string, chat_id, message_id
            )
